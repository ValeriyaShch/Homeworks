...
class App extends Component {
    constructor(props) {
        super(props);
        this.state = {
            smiles: [{id: 1, image: hug, vote: 0}, {id: 2, image: shy, vote: 0}, {id: 3, image: smile, vote: 0}, {
                id: 4,
                image: wink,
                vote: 0
            }, {id: 5, image: suspicious, vote: 0},], isResultVisible: false, maxVote: 0, bestImage: null
    ...
    showWinner() {
        this.setState((prevState) => {
            const updatedState = {
                ...prevState, isResultVisible: true
            }
            localStorage.setItem('smiles', JSON.stringify(updatedState));
    ...
    render() {
        return (<div className="container center">
            ...
            {this.state.isResultVisible ?
                <Winner key={0} vote={this.state.maxVote} image={this.state.bestImage}/> : null}
        </div>)
    }
}
